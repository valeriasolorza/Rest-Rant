...
function show(data) {
  ...
  let rating = (
    <h3 className="inactive" style={{ color: "darkgray" }}>
      Not yet rated!
    </h3>
  );
      ...
      <main className="show-main">
        ...
        <section className="main-right-section">
          ...
          <div className="show-edit-delete-buttons">
            <button className="btn btn-warning" style={{ marginRight: "10px" }}>
              <a href={`/places/${data.place._id}/edit`}>Edit</a>
            </button>
        ...
        <section className="row main-mid-section">
          <div>
            ...
            <div className="section-mid-comments">{comments}</div>
          </div>
        </section>
        ...
        <section className="row main-bottom-section">
          ...
          <form
            id="comment-form"
            action={`/places/${data.place._id}/comment`}
            method="POST"
          >
